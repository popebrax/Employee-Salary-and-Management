...
const app = express();
const port = 8000;
const host = 'localhost'; //if you are using expo go app, you need to type ifconfig on terminal and enter the ip address, also note that you need to be connected to your phones hotspot to do this
